...
const currentBase = ref(bases.value[2]); // Default to Coffee
const currentCreamer = ref(creamers.value[0]); // Default to No Cream
const currentSyrup = ref(syrups.value[0]); // Default to No Syrup
